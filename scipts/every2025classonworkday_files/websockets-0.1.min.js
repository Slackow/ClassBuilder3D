!function(I){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=I();else if("function"==typeof define&&define.amd)define([],I);else{var b;"undefined"!=typeof window?b=window:"undefined"!=typeof global?b=global:"undefined"!=typeof self&&(b=self);b.SockJS=I()}}(function(){return function b(e,a,d){function c(f,l){if(!a[f]){if(!e[f]){var n="function"==typeof require&&require;if(!l&&n)return n(f,!0);if(h)return h(f,!0);n=Error("Cannot find module '"+f+"'");throw n.code="MODULE_NOT_FOUND",
...
d=b("./utils/event"),c=b("json3"),h=b("./facade"),f=b("./info-iframe-receiver"),g=b("./utils/iframe"),l=b("./location");e.exports=function(b,k){var e={};k.forEach(function(a){a.facadeTransport&&(e[a.facadeTransport.transportName]=a.facadeTransport)});e[f.transportName]=f;var m;b.bootstrap_iframe=function(){var f;g.currentWindowId=l.hash.slice(1);d.attachEvent("message",function(d){if(d.source===parent&&("undefined"==typeof m&&(m=d.origin),d.origin===m)){var k;try{k=c.parse(d.data)}catch(w){return}if(k.windowId===
g.currentWindowId)switch(k.type){case "s":var u;try{u=c.parse(k.data)}catch(A){break}d=u[0];k=u[1];var C=u[2];u=u[3];if(d!==b.version)throw Error('Incompatibile SockJS! Main site uses: "'+d+'", the iframe: "'+b.version+'".');if(!a.isOriginEqual(C,l.href)||!a.isOriginEqual(u,l.href))throw Error("Can't connect to different domain from within an iframe. ("+l.href+", "+C+", "+u+")");f=new h(new e[k](C,u));break;case "m":f._send(k.data);break;case "c":f&&f._close(),f=null}}});g.postMessage("s")}}},{"./facade":7,
...
arguments.length)throw new TypeError("Failed to construct 'SockJS: 1 argument required, but only 0 present");u.call(this);this.readyState=d.CONNECTING;this.protocol=this.extensions="";f=f||{};f.protocols_whitelist&&z.warn("'protocols_whitelist' is DEPRECATED. Use 'transports' instead.");this._transportsWhitelist=f.transports;var g=f.sessionId||8;if("function"==typeof g)this._generateSessionId=g;else{if("number"!=typeof g)throw new TypeError("If sessionId is used in the options, it needs to be a number or a function.");
this._generateSessionId=function(){return l.string(g)}}this._server=f.server||l.numberString(1E3);var c=new h(a);if(!c.host||!c.protocol)throw new SyntaxError("The URL '"+a+"' is invalid");if(c.hash)throw new SyntaxError("The URL must not contain a fragment");if("http:"!==c.protocol&&"https:"!==c.protocol)throw new SyntaxError("The URL's scheme must be either 'http:' or 'https:'. '"+c.protocol+"' is not allowed.");var n="https:"===c.protocol;if("https"===A.protocol&&!n)throw Error("SecurityError: An insecure SockJS connection may not be initiated from a page loaded over HTTPS");
b?Array.isArray(b)||(b=[b]):b=[];var e=b.sort();e.forEach(function(a,b){if(!a)throw new SyntaxError("The protocols entry '"+a+"' is invalid.");if(b<e.length-1&&a===e[b+1])throw new SyntaxError("The protocols entry '"+a+"' is duplicated.");});this._origin=(n=k.getOrigin(A.href))?n.toLowerCase():null;c.set("pathname",c.pathname.replace(/\/+$/,""));this.url=c.href;this._urlInfo={nullOrigin:!t.hasDomain(),sameOrigin:k.isOriginEqual(this.url,A.href),sameScheme:k.isSchemeEqual(this.url,A.href)};this._ir=
new T(this.url,this._urlInfo);this._ir.once("finish",this._receiveInfo.bind(this))}b("./shims");var c,h=b("url-parse"),f=b("inherits"),g=b("json3"),l=b("./utils/random"),n=b("./utils/escape"),k=b("./utils/url"),q=b("./utils/event"),m=b("./utils/transport"),r=b("./utils/object"),t=b("./utils/browser"),z=b("./utils/log"),w=b("./event/event"),u=b("./event/eventtarget"),A=b("./location"),C=b("./event/close"),B=b("./event/trans-message"),T=b("./info-receiver");f(d,u);d.prototype.close=function(a,b){if(a&&
...
0,"");h._cleanup(!1)})}catch(e){return this.emit("finish",0,""),void this._cleanup(!1)}if(k&&k.noCredentials||!d.supportsCORS||(this.xhr.withCredentials="true"),k&&k.headers)for(var A in k.headers)this.xhr.setRequestHeader(A,k.headers[A]);this.xhr.onreadystatechange=function(){if(h.xhr){var a,b,f=h.xhr;switch(f.readyState){case 3:try{b=f.status,a=f.responseText}catch(d){}1223===b&&(b=204);200===b&&a&&0<a.length&&h.emit("chunk",b,a);break;case 4:b=f.status,1223===b&&(b=204),12005!==b&&12029!==b||(b=
0),h.emit("finish",b,f.responseText),h._cleanup(!1)}}};try{h.xhr.send(c)}catch(C){h.emit("finish",0,""),h._cleanup(!1)}};d.prototype._cleanup=function(a){if(this.xhr){if(this.removeAllListeners(),f.unloadDel(this.unloadRef),this.xhr.onreadystatechange=function(){},this.xhr.ontimeout&&(this.xhr.ontimeout=null),a)try{this.xhr.abort()}catch(b){}this.unloadRef=this.xhr=null}};d.prototype.close=function(){this._cleanup(!0)};d.enabled=!!l;var n=["Active"].concat("Object").join("X");!d.enabled&&n in a&&
...
h=setTimeout(function(){k&&(m(),c("timeout"))},15E3),e=d.unloadAdd(m),{post:function(a,b){try{setTimeout(function(){k&&k.contentWindow&&k.contentWindow.postMessage(a,b)},0)}catch(d){}},cleanup:m,loaded:q}},createHtmlfile:function(b,c){var h,n,k,q=["Active"].concat("Object").join("X"),m=new a[q]("htmlfile"),r=function(){clearTimeout(h);k.onerror=null},t=function(){m&&(r(),d.unloadDel(n),k.parentNode.removeChild(k),k=m=null,CollectGarbage())};m.open();m.write('<html><script>document.domain="'+a.document.domain+
'";\x3c/script></html>');m.close();m.parentWindow[e.exports.WPrefix]=a[e.exports.WPrefix];q=m.createElement("div");return m.body.appendChild(q),k=m.createElement("iframe"),q.appendChild(k),k.src=b,k.onerror=function(){m&&(t(),c("onerror"))},h=setTimeout(function(){m&&(t(),c("timeout"))},15E3),n=d.unloadAdd(t),{post:function(a,b){try{setTimeout(function(){k&&k.contentWindow&&k.contentWindow.postMessage(a,b)},0)}catch(d){}},cleanup:t,loaded:r}}};e.exports.iframeEnabled=!1;a.document&&(e.exports.iframeEnabled=
...
b){function d(a){if(d[a]!==D)return d[a];var c;if("bug-string-char-index"==a)c="a"!="a"[0];else if("json"==a)c=d("json-stringify")&&d("json-parse");else{var g;if("json-stringify"==a){c=b.stringify;var h="function"==typeof c&&E;if(h){(g=function(){return 1}).toJSON=g;try{h="0"===c(0)&&"0"===c(new f)&&'""'==c(new e)&&c(y)===D&&c(D)===D&&c()===D&&"1"===c(g)&&"[1]"==c([g])&&"[null]"==c([D])&&"null"==c(null)&&"[null,null,null]"==c([D,y,null])&&'{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'==c({a:[g,
...
1!==c("01")}catch(q){}if(n)try{n=1!==c("1.")}catch(p){}}}}catch(r){n=!1}c=n}}return d[a]=!!c}a||(a=g.Object());b||(b=g.Object());var f=a.Number||g.Number,e=a.String||g.String,l=a.Object||g.Object,k=a.Date||g.Date,n=a.SyntaxError||g.SyntaxError,m=a.TypeError||g.TypeError,q=a.Math||g.Math,M=a.JSON||g.JSON;"object"==typeof M&&M&&(b.stringify=M.stringify,b.parse=M.parse);var x,J,D,l=l.prototype,y=l.toString,E=new k(-0xc782b5b800cec);try{E=-109252==E.getUTCFullYear()&&0===E.getUTCMonth()&&1===E.getUTCDate()&&
10==E.getUTCHours()&&37==E.getUTCMinutes()&&6==E.getUTCSeconds()&&708==E.getUTCMilliseconds()}catch(Y){}if(!d("json")){var K=d("bug-string-char-index");if(!E)var F=q.floor,U=[0,31,59,90,120,151,181,212,243,273,304,334],L=function(a,b){return U[b]+365*(a-1970)+F((a-1969+(b=+(1<b)))/4)-F((a-1901+b)/100)+F((a-1601+b)/400)};if((x=l.hasOwnProperty)||(x=function(a){var b,c={};return(c.__proto__=null,c.__proto__={toString:1},c).toString!=y?x=function(a){var b=this.__proto__;a=a in(this.__proto__=null,this);
return this.__proto__=b,a}:(b=c.constructor,x=function(a){var c=(this.constructor||b).prototype;return a in this&&!(a in c&&this[a]===c[a])}),c=null,x.call(this,a)}),J=function(a,b){var c,d,f,g=0;(c=function(){this.valueOf=0}).prototype.valueOf=0;d=new c;for(f in d)x.call(d,f)&&g++;return c=d=null,g?J=2==g?function(a,b){var c,d={},f="[object Function]"==y.call(a);for(c in a)f&&"prototype"==c||x.call(d,c)||!(d[c]=1)||!x.call(a,c)||b(c)}:function(a,b){var c,d,f="[object Function]"==y.call(a);for(c in a)f&&
"prototype"==c||!x.call(a,c)||(d="constructor"===c)||b(c);(d||x.call(a,c="constructor"))&&b(c)}:(d="valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "),J=function(a,b){var c,f;f="[object Function]"==y.call(a);var g=!f&&"function"!=typeof a.constructor&&h[typeof a.hasOwnProperty]&&a.hasOwnProperty||x;for(c in a)f&&"prototype"==c||!g.call(a,c)||b(c);for(f=d.length;c=d[--f];g.call(a,c)&&b(c));}),J(a,b)},!d("json-stringify")){var V={92:"\\\\",34:'\\"',
8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},G=function(a,b){return("000000"+(b||0)).slice(-a)},Q=function(a){for(var b='"',c=0,d=a.length,f=!K||10<d,g=f&&(K?a.split(""):a);d>c;c++){var h=a.charCodeAt(c);switch(h){case 8:case 9:case 10:case 12:case 13:case 34:case 92:b+=V[h];break;default:if(32>h){b+="\\u00"+G(2,h.toString(16));break}b+=f?g[c]:a.charAt(c)}}return b+'"'},O=function(a,b,c,d,f,g,h){var e,l,k,n,q,p,r,t,v,u;try{e=b[a]}catch(w){}if("object"==typeof e&&e)if(l=y.call(e),"[object Date]"!=l||
x.call(e,"toJSON"))"function"==typeof e.toJSON&&("[object Number]"!=l&&"[object String]"!=l&&"[object Array]"!=l||x.call(e,"toJSON"))&&(e=e.toJSON(a));else if(e>-1/0&&1/0>e){if(L){q=F(e/864E5);for(k=F(q/365.2425)+1970-1;L(k+1,0)<=q;k++);for(n=F((q-L(k,0))/30.42);L(k,n+1)<=q;n++);q=1+q-L(k,n);p=(e%864E5+864E5)%864E5;r=F(p/36E5)%24;t=F(p/6E4)%60;v=F(p/1E3)%60;p%=1E3}else k=e.getUTCFullYear(),n=e.getUTCMonth(),q=e.getUTCDate(),r=e.getUTCHours(),t=e.getUTCMinutes(),v=e.getUTCSeconds(),p=e.getUTCMilliseconds();
e=(0>=k||1E4<=k?(0>k?"-":"+")+G(6,0>k?-k:k):G(4,k))+"-"+G(2,n+1)+"-"+G(2,q)+"T"+G(2,r)+":"+G(2,t)+":"+G(2,v)+"."+G(3,p)+"Z"}else e=null;if(c&&(e=c.call(b,a,e)),null===e)return"null";if(l=y.call(e),"[object Boolean]"==l)return""+e;if("[object Number]"==l)return e>-1/0&&1/0>e?""+e:"null";if("[object String]"==l)return Q(""+e);if("object"==typeof e){for(a=h.length;a--;)if(h[a]===e)throw m();if(h.push(e),u=[],b=g,g+=f,"[object Array]"==l){k=0;for(a=e.length;a>k;k++)l=O(k,e,c,d,f,g,h),u.push(l===D?"null":
l);l=u.length?f?"[\n"+g+u.join(",\n"+g)+"\n"+b+"]":"["+u.join(",")+"]":"[]"}else J(d||e,function(a){var b=O(a,e,c,d,f,g,h);b!==D&&u.push(Q(a)+":"+(f?" ":"")+b)}),l=u.length?f?"{\n"+g+u.join(",\n"+g)+"\n"+b+"}":"{"+u.join(",")+"}":"{}";return h.pop(),l}};b.stringify=function(a,b,c){var d,f,g,e;if(h[typeof b]&&b)if("[object Function]"==(e=y.call(b)))f=b;else if("[object Array]"==e){g={};for(var l,k=0,n=b.length;n>k;l=b[k++],e=y.call(l),("[object String]"==e||"[object Number]"==e)&&(g[l]=1));}if(c)if("[object Number]"==
(e=y.call(c))){if(0<(c-=c%1))for(d="",10<c&&(c=10);d.length<c;d+=" ");}else"[object String]"==e&&(d=10>=c.length?c:c.slice(0,10));return O("",(l={},l[""]=a,l),f,g,d,"",[])}}if(!d("json-parse")){var p,N,W=e.fromCharCode,X={92:"\\",34:'"',47:"/",98:"\b",116:"\t",110:"\n",102:"\f",114:"\r"},v=function(){throw p=N=null,n();},H=function(){for(var a,b,c,d,f,g=N,e=g.length;e>p;)switch(f=g.charCodeAt(p)){case 9:case 10:case 13:case 32:p++;break;case 123:case 125:case 91:case 93:case 58:case 44:return a=K?
g.charAt(p):g[p],p++,a;case 34:a="@";for(p++;e>p;)if(f=g.charCodeAt(p),32>f)v();else if(92==f)switch(f=g.charCodeAt(++p)){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:a+=X[f];p++;break;case 117:b=++p;for(c=p+4;c>p;p++)f=g.charCodeAt(p),48<=f&&57>=f||97<=f&&102>=f||65<=f&&70>=f||v();a+=W("0x"+g.slice(b,p));break;default:v()}else{if(34==f)break;f=g.charCodeAt(p);for(b=p;32<=f&&92!=f&&34!=f;)f=g.charCodeAt(++p);a+=g.slice(b,p)}if(34==g.charCodeAt(p))return p++,a;v();default:if(b=
p,45==f&&(d=!0,f=g.charCodeAt(++p)),48<=f&&57>=f){for(48==f&&(f=g.charCodeAt(p+1),48<=f&&57>=f)&&v();e>p&&(f=g.charCodeAt(p),48<=f&&57>=f);p++);if(46==g.charCodeAt(p)){for(c=++p;e>c&&(f=g.charCodeAt(c),48<=f&&57>=f);c++);c==p&&v();p=c}if(f=g.charCodeAt(p),101==f||69==f){f=g.charCodeAt(++p);43!=f&&45!=f||p++;for(c=p;e>c&&(f=g.charCodeAt(c),48<=f&&57>=f);c++);c==p&&v();p=c}return+g.slice(b,p)}if(d&&v(),"true"==g.slice(p,p+4))return p+=4,!0;if("false"==g.slice(p,p+5))return p+=5,!1;if("null"==g.slice(p,
p+4))return p+=4,null;v()}return"$"},P=function(a){var b,c;if("$"==a&&v(),"string"==typeof a){if("@"==(K?a.charAt(0):a[0]))return a.slice(1);if("["==a){for(b=[];a=H(),"]"!=a;c||(c=!0))c&&(","==a?(a=H(),"]"==a&&v()):v()),","==a&&v(),b.push(P(a));return b}if("{"==a){for(b={};a=H(),"}"!=a;c||(c=!0))c&&(","==a?(a=H(),"}"==a&&v()):v()),","!=a&&"string"==typeof a&&"@"==(K?a.charAt(0):a[0])&&":"==H()||v(),b[a.slice(1)]=P(H());return b}v()}return a},S=function(a,b,c){c=R(a,b,c);c===D?delete a[b]:a[b]=c},
R=function(a,b,c){var d,f=a[b];if("object"==typeof f&&f)if("[object Array]"==y.call(f))for(d=f.length;d--;)S(f,d,c);else J(f,function(a){S(f,a,c)});return c.call(a,b,f)};b.parse=function(a,b){var c,d;return p=0,N=""+a,c=P(H()),"$"!=H()&&v(),p=N=null,b&&"[object Function]"==y.call(b)?R((d={},d[""]=c,d),"",b):c}}}return b.runInContext=c,b}var h={"function":!0,object:!0},f=h[typeof a]&&a&&!a.nodeType&&a,g=h[typeof window]&&window||this,l=f&&h[typeof e]&&e&&!e.nodeType&&"object"==typeof b&&b;if(!l||l.global!==
l&&l.window!==l&&l.self!==l||(g=l),f&&!0)c(g,f);else{var n=g.JSON,k=g.JSON3,q=!1,m=c(g,g.JSON3={noConflict:function(){return q||(q=!0,g.JSON=n,g.JSON3=k,n=k=null),m}});g.JSON={parse:m.parse,stringify:m.stringify}}}).call(this)}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],56:[function(b,e){function a(b,e,k){if(!(this instanceof a))return new a(b,e,k);var q,m,r,t,z=f.test(b);q=typeof e;var w=0;"object"!==q&&"string"!==q&&(k=e,
e=null);k&&"function"!=typeof k&&(k=h.parse);for(e=c(e);w<g.length;w++)m=g[w],q=m[0],t=m[1],q!==q?this[t]=b:"string"==typeof q?~(r=b.indexOf(q))&&("number"==typeof m[2]?(this[t]=b.slice(0,r),b=b.slice(r+m[2])):(this[t]=b.slice(r),b=b.slice(0,r))):(r=q.exec(b))&&(this[t]=r[1],b=b.slice(0,b.length-r[0].length)),this[t]=this[t]||(m[3]||"port"===t&&z?e[t]||"":""),m[4]&&(this[t]=this[t].toLowerCase());k&&(this.query=k(this.query));d(this.port,this.protocol)||(this.host=this.hostname,this.port="");this.username=
...
f,l,t,z,w,u,A,C,B;d="undefined"!==typeof ArrayBuffer&&d.data instanceof ArrayBuffer?(e=new Uint8Array(d.data),"function"===typeof a.debug?a.debug("--- got data length: "+e.length):void 0,function(){var a,b,c;c=[];a=0;for(b=e.length;a<b;a++)f=e[a],c.push(String.fromCharCode(f));return c}().join("")):d.data;a.serverActivity=h();if("\n"===d)"function"===typeof a.debug&&a.debug("<<< PONG");else{"function"===typeof a.debug&&a.debug("<<< "+d);C=b.unmarshall(d);B=[];u=0;for(A=C.length;u<A;u++)switch(d=C[u],
d.command){case "CONNECTED":"function"===typeof a.debug&&a.debug("connected to server "+d.headers.server);a.connected=!0;a._setupHeartbeat(d.headers);B.push("function"===typeof a.connectCallback?a.connectCallback(d):void 0);break;case "MESSAGE":w=d.headers.subscription;(z=a.subscriptions[w]||a.onreceive)?(l=a,t=d.headers["message-id"],d.ack=function(a){null==a&&(a={});return l.ack(t,w,a)},d.nack=function(a){null==a&&(a={});return l.nack(t,w,a)},B.push(z(d))):B.push("function"===typeof a.debug?a.debug("Unhandled received MESSAGE: "+
d):void 0);break;case "RECEIPT":B.push("function"===typeof a.onreceipt?a.onreceipt(d):void 0);break;case "ERROR":B.push("function"===typeof c?c(d):void 0);break;default:B.push("function"===typeof a.debug?a.debug("Unhandled frame: "+d):void 0)}return B}}}(this);this.ws.onclose=function(a){return function(){var b;b="Whoops! Lost connection to "+a.ws.url;"function"===typeof a.debug&&a.debug(b);a._cleanUp();return"function"===typeof c?c(b):void 0}}(this);return this.ws.onopen=function(a){return function(){"function"===
...
a;c.subscription=b;return this._transmit("NACK",c)};return a}();e={VERSIONS:{V1_0:"1.0",V1_1:"1.1",V1_2:"1.2",supportedVersions:function(){return"1.1,1.0"}},client:function(a,b){var d;null==b&&(b=["v10.stomp","v11.stomp"]);d=new (e.WebSocketClass||WebSocket)(a,b);return new I(d)},over:function(a){return new I(a)},Frame:b};"undefined"!==typeof exports&&null!==exports&&(exports.Stomp=e);"undefined"!==typeof window&&null!==window?(e.setInterval=function(a,b){return window.setInterval(b,a)},e.clearInterval=
